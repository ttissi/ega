						    ...
						    <div class="col-md-12">
					        	<div class="form-group">
						            <div class="input-group">
							            ...
							            <input type="text" class="form-control" name="email" id="email" placeholder="Ex: adresse@email.com" value="<?php echo strtolower($w_user['email']); ?>">
						            </div>
						        </div>
					        </div>
					    </div>
...
<!-- 	        	 <div class="col-md-4 col-md-offset-1 well bkg-vert-clair">
		...
		<div class="row">
			<div class="col-md-2 col-md-offset-1">
			        	<a class="btn btn-primary" name="btnModifPwd" href="<?= $this->url('membre_pwdNew', ['numEgaMembre' => $w_user['num_ega']]); ?>">Changer de mot de passe</a>
			        </div>
