		        	...
		        	<li class="dropdown">
		          	...
		          	<li class="dropdown">
		          	    ...
		          	    <ul class="dropdown-menu" role="menu">
							...
							<li><a href="#" data-toggle="modal" data-target="#connexionModal" data-whatever=""><i class="fa fa-toggle-on fa-fw" aria-hidden="true"></i> Se connecter</a></li>
...
<!-- A SUPPRIMER -->
							...
							<!-- <li><a class="sm-modal" href="<?= $this->url('membre_seConnecterModal'); ?>"><i class="fa fa-toggle-on fa-fw" aria-hidden="true"></i> (Se connecter 2)</a></li> -->
							<!-- <li><button type="button" class="btn btn-danger" id="click_to_load_modal_popup" value="<?= $this->url('membre_seConnecter'); ?>">Connexion Modale</button></li> -->
		                	...
		                	<li><?= $this->url('membre_seConnecter'); ?></li>
<!--  -->
	...
	<div id="connexionModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="connexionModalLabel2">
